...
- **進行中ブランチ**: `reading/vertical-p4`＝縦書きの章送り（P4）。縦書き本体（P0〜P3・P5・P2.5）は実装完了・main 統合済み＝縦書きはユーザー到達可能（ADR 0020〔連続横スクロール×自前Compose組版〕・設計の正本＝`handover.md` 縦書き節・`.claude/plans/vertical-reading-mode.md`。worktree `~/wt/reading-vertical-p4`）。
